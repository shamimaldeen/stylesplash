                        ...
                        <div class="row">
                            <div class="col-sm-6" id="payment_from_1">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" size="100"  name="customer_name" class="customerSelection form-control" placeholder='<?php echo display('customer_name').'/'.display('phone') ?>' id="customer_name" tabindex="3"  onkeyup="customer_autocomplete()" required/>
                                ...
                                <textarea name="inva_details" class="form-control" placeholder="<?php echo display('invoice_details') ?>"></textarea>
                                    ...
                                    <td class="text-right">
                                     ...
                                     <tr>
                                         ...
                                         <td class="text-right">
                                             <input type="text" id="vat_cost" class="form-control text-right" name="vat_cost" required="" onkeyup="vatCal()"     placeholder="0.00"  />
                                         </td>
                                     </tr>
                ...
                <i class="fa fa-angle-double-down"></i>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <select name="not_show" class="form-control" id="not_show">
