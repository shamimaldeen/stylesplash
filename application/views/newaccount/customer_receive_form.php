                       ...
                       <div class="table-responsive">
                           ...
                           <select name="customer_id" id="customer_id_1" class="form-control" onchange="load_customer_code(this.value,1)" required>
                            ...
                            <?php foreach ($invoice_list as $invoice) {?>
                                <option value="<?php echo html_escape($invoice->customer_id);?>"><?php echo html_escape($invoice->invoice);?> <strong> (<?php echo html_escape($invoice->customer_name);?>) </strong>- <strong> (<?php echo html_escape($invoice->due_amount) ;?> tk ) </strong></option>
                             <?php } ?>
