...
if(isset($_POST['btnSave']))
{
    ...
    // $todayDate = (!empty(date("Y-m-d"))?html_escape(date("Y-m-d")):'');
    // $todaySql = $this->accounts_model->cashbook_firstqury($todayDate,$HeadCode);

    if($oResult->num_rows>0)
    {
        $PreBalanceCredit=$oResult->row['Credit'];
        $PreBalanceDebit=$oResult->row['Debit'];
        $PreBalance= $PreBalance - $PreBalanceDebit;
    ...
    $todayDate = (!empty(date('Y-m-d'))?html_escape(date('Y-m-d')):'');
    $todaySql=$this->accounts_model->cashbook_secondqury($todayDate,$HeadCode,$todayDate);
    $todayResult = $oAccount->SqlQuery($todaySql);
//     echo '<pre>';
//     var_dump($todayResult);
//     die();
    $todayHandCash = 0;
    $todayExpenseTest = 0;
    for($i=0;$i<(!empty($todayResult->num_rows)?$todayResult->num_rows:0);$i++)
    {

     $todayHandCash +=  $todayResult->rows[$i]['Debit'];
     $todayExpenseTest +=  $todayResult->rows[$i]['Credit'];
    //  echo $todayExpense;
    //  die();
    }
            ...
            <div class="panel-body"  id="printArea">
                ...
                <div>
                    ...
                    <tr class="table_data">
                            ...
                            <td align="right"><?php echo number_format((!empty($PreBalanceDebit)?$PreBalanceDebit:0),2,'.',','); ?></td>
                        </tr>
                        <tr class="table_head">
                        ...
                        for($i=0;$i<(!empty($oResult->num_rows)?$oResult->num_rows:0);$i++)
                        {
                            ...
                            $debitData = number_format($oResult->rows[$i]['Debit'],2,'.',',');
                        ...
                        <tr class="table_data print-footercolor">
                            ...
                            <td align="center"  bgcolor="green">&nbsp;</td>
                            <td align="center"  bgcolor="green">&nbsp;</td>
                            <td  align="right"  bgcolor="green"><strong>Today Cash Recv</strong></td>
                            <td  align="right"  bgcolor="green"><?php  echo number_format((!empty($todayHandCash)?$todayHandCash:0),2,'.',',');  ?></td>
                        ...
                        <tr class="table_data print-footercolor">
                            ...
                            <td align="center"  bgcolor="green">&nbsp;</td>
                            <td align="center"  bgcolor="green">&nbsp;</td>
                            <td  align="right"  bgcolor="green"><strong>Total Cash Recv</strong></td>
                        ...
                        <tr class="table_data print-footercolor">
                            ...
                            <td align="center"  bgcolor="green">&nbsp;</td>
                            <td align="center"  bgcolor="green">&nbsp;</td>
                            <td  align="right"  bgcolor="green"><strong>Today Expense</strong></td>
                            <td  align="right"  bgcolor="green"><?php echo number_format((!empty($todayExpenseTest)?$todayExpenseTest:0),2,'.',','); ?></td>
                            <!-- <td  align="right"  bgcolor="green"><?php //echo number_format((!empty($PreBalance)?$PreBalance:0),2,'.',','); ?></td> -->
                        ...
                        <tr class="table_data print-footercolor">
                            ...
                            <td align="center"  bgcolor="green">&nbsp;</td>
                            <td align="center"  bgcolor="green">&nbsp;</td>
                            <td  align="right"  bgcolor="green"><strong>Cash In Hand</strong></td>
                            <!-- <td  align="right"  bgcolor="green"><?php// echo $todayExpenseTest; ?></td> -->
                            <td  align="right"  bgcolor="green"><?php echo number_format((!empty($PreBalance)?$PreBalance:0),2,'.',','); ?></td>
                    ...
                    <tr class="table_data">
                            ...
                            <!-- <td align="center">&nbsp;</td> -->
                            <td colspan="3" align="right"><strong><?php echo display('opening_balance')?></strong></td>
                            <td align="right"><?php echo number_format((!empty($PreBalanceCredit)?$PreBalanceCredit:0),2,'.',','); ?></td>
                        </tr>
                        <tr class="table_head">
                            <td align="center"><strong><?php echo display('sl')?></strong></td>
                            <td align="center"><strong><?php echo display('date')?></strong></td>
                        ...
                        for($i=0;$i<(!empty($oResult->num_rows)?$oResult->num_rows:0);$i++)
                        {
                            ...
                            <?php
                                    ...
                                    $creditData = number_format($oResult->rows[$i]['Credit'],2,'.',',');
