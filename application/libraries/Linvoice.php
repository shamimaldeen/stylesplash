...
//        var_dump($invoice_detail); exit();
        ...
        $totalbal_not_show = $invoice_detail[0]['total_amount']+$invoice_detail[0]['total_tax'];
        $user_id = $invoice_detail[0]['sales_by'];
        $users = $CI->Invoices->user_invoice_data($user_id);
        $data = array(
        'title'                => display('invoice_details'),
        ...
        'final_date'           => $invoice_detail[0]['final_date'],
        'invoice_details'      => $invoice_detail[0]['invoice_details'],
        'total_amount'         => ($invoice_detail[0]['not_show']==0) ? number_format($totalbal, 2, '.', ',') : $totalbal_not_show, 
        'subTotal_cartoon'     => $subTotal_cartoon,
        'subTotal_quantity'    => $subTotal_quantity,
        'discount_type'        => 1,
        'invoice_discount'     => number_format($invoice_detail[0]['invoice_discount'], 2, '.', ','),
